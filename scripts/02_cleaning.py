...
def main():
    ...
    try:
        ...
        print("Step 1: Loading raw season files from data/raw/...")
        upl_goals = consolidate_seasons(RAW_SEASON_FILES, file_exists_check=True)
        print(f"  ✓ Consolidated {len(upl_goals)} rows from {len(RAW_SEASON_FILES)} seasons\n")
